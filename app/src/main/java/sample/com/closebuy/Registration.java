...
public class Registration extends AppCompatActivity {
    EditText uname, uphone, dob, email, address, pass, conpass;
    ...
    Button submit;
    String name, phno, dob1, email1, fpass;
    static final int DATE_PICKER_ID = 0;
    String tgender_string;
    private int day, month, year;
    String formattedMonth;
    String customerid, phone, passwordva;
...
/*********Gallery********/
            ...
            public void onClick(View v) {
                ...
                else
                {
                    ...
                    if (!isInternetPresent) {
                        ...
                        fpass = conpass.getText().toString();
                        dob1 = dob.getText().toString();
                        phno = uphone.getText().toString();
                        ...
                        System.out.println("tgender--" + tgender_string);

                        signupreg task = new signupreg();

                        task.execute(new String[]{"http://quotecp.com:444/api/Customer"});
                    }
    ...
    private class signupreg extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... urls) {
            ...
            try {
                urlParameters =
                        "&CustomerName=" + URLEncoder.encode(name, "UTF-8") +
                                "&PhoneNumber=" + URLEncoder.encode(phno, "UTF-8") +
                                "&EmailID=" + URLEncoder.encode(email1, "UTF-8") +
                                "&DOB=" + URLEncoder.encode(dob1, "UTF-8") +
                                "&Gender=" + URLEncoder.encode(tgender_string, "UTF-8") +
                                "&Password=" + URLEncoder.encode(fpass, "UTF-8")+
            ...
            try {
                ...
                for (int i = 0; i < arr.length(); i++) {
                    ...
                    if (state.equals("Success")) {
                        ...
                        loginSessionManager.createLoginSession(phone, customerid, passwordva);
    ...
    private void updateDisplay() {
        dob.setText(//this is the edit text where you want to show the selected date
                new StringBuilder()
